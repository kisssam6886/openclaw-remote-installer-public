...
$archiveUrl = if ($env:OPENCLAW_INSTALL_ARCHIVE_URL) { $env:OPENCLAW_INSTALL_ARCHIVE_URL } else { "https://raw.githubusercontent.com/kisssam6886/openclaw-remote-installer-public/main/releases/openclaw-remote-installer-main.zip" }
